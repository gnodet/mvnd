...
public class SyncContextTest {
    ...
    @Test
    void testContextSimple() throws Exception {
        SyncContextFactory factory = new MvndSyncContextFactory();

        DefaultRepositorySystemSession session = new DefaultRepositorySystemSession();
        LocalRepository repository = new LocalRepository(new File("foo"));
        LocalRepositoryManager localRepositoryManager = new SimpleLocalRepositoryManagerFactory().newInstance(session,
                repository);
